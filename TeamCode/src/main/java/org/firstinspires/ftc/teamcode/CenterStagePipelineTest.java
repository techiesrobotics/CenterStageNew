...
public class CenterStagePipelineTest extends LinearOpMode {
    OpenCvCamera webcam;
    CSPipeline pipeline;
...
class CSPipeline extends OpenCvPipeline {
    /*
    ...
    public int convert (){
        ...
        else if (getAnalysis().equals(FreightLocation.ONE)){
            return 2;
        }
        else if (getAnalysis().equals(FreightLocation.ONE)){
            return 3;
